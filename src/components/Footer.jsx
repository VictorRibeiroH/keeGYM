  ...
  return (
    <footer className="bg-gray-900 text-white py-8">
      <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between">
        ...
        <nav className="mb-4 lg:mb-0">
          <ul className="flex space-x-4">
            ...
            <li>
              <a href="#generator-section" className="hover:text-blue-400">
                Fichas de treino
              </a>
            </li>
            <li>
              <a href="#beneficios" className="hover:text-blue-400">
                Beneficios
              </a>
            </li>
            <li>
        ...
        {/* Logos do LinkedIn e GitHub */}
        <div className="flex space-x-4">
          <a
            href="https://www.linkedin.com/in/victor-ribeiroh/"
            target="_blank"
      ...
      <div className="text-center pt-4">
        <p style={{ marginLeft: "78px" }}>© 2024 Copyright - Víctor Ribeiro</p>
      </div>
    </footer>
  );
}
